    ...
    <div class="row mt-4 mb-4">
        <div class="col">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    {{ Form::text('slug', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.access.email-templates.slug')]) }}
                </div>
                <!--col-->
            </div>
            <!--form-group-->
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    {{ Form::text('content', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.access.email-templates.content')]) }}
                </div>
                <!--col-->
            </div>
            <!--form-group-->
